...
ALTER TABLE BANGCAP ADD 
  CONSTRAINT FK_BANGCAP_HOSOUNGTUYEN FOREIGN KEY (IDUngVien) REFERENCES HOSO(IDUngVien);
...
ALTER TABLE HOSOUNGTUYEN ADD 
  ...
  CONSTRAINT FK_HOSOUNGTUYEN_UNGVIEN FOREIGN KEY (IDUngVien) REFERENCES HOSO(IDUngVien);
