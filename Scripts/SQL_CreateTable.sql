...
CREATE TABLE UNGTUYEN (
  ...
  DiemDanhGia INT
  PRIMARY KEY (IDDoanhNghiep, IDHoSo)
);
...
ALTER TABLE HOSO ADD 
  CONSTRAINT FK_HOSO_UNGVIEN FOREIGN KEY (IDUngVien) REFERENCES UNGVIEN(IDUngVien);

ALTER TABLE BANGCAP ADD 
  CONSTRAINT FK_BANGCAP_HOSO FOREIGN KEY (IDHoSo) REFERENCES HOSO(IDHoSo);

ALTER TABLE UNGTUYEN ADD 
  CONSTRAINT FK_UNGTUYEN_DOANHNGHIEP FOREIGN KEY (IDDoanhNghiep) REFERENCES DOANHNGHIEP(IDDoanhNghiep),
  CONSTRAINT FK_UNGTUYEN_HOSO FOREIGN KEY (IDHoSo) REFERENCES HOSO(IDHoSo);
